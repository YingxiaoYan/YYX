...
#dataX=Xotu
#dataY=Yotu
#empty_name<-"BER_vector_modelRF_MUVR_perm<-vector(length=rep)
#            MISS_vector_modelRF_MUVR_perm<-vector(length=rep)"
#some_operation_before<-"dataYPerm = sampling_from_distribution(dataY)"
...
#record_values<-"BER_vector_modelRF_MUVR_perm[i]<- perm$ber['min']
#MISS_vector_modelRF_MUVR_perm[i]<-perm$miss['min']"
#output<-"list(BER_vector_modelRF_MUVR_perm,MISS_vector_modelRF_MUVR_perm)"
